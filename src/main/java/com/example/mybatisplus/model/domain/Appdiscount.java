...
@ApiModel(value="Appdiscount对象", description="")
public class Appdiscount extends Model<Appdiscount> {
    ...
    private List<UserAppdiscount> userAppdiscounts;
    ...
    public List<UserAppdiscount> getUserAppdiscounts() {
        return userAppdiscounts;
    }

    public void setUserAppdiscounts(List<UserAppdiscount> userAppdiscounts) {
        this.userAppdiscounts = userAppdiscounts;
    }
}
